...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="sidebarsss.css">
...
<body>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="">Event</label>
                        <p id="view_eventName" class="form-control"></p>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
    ...
    <script>
        $(document).ready(function () {
            ...
            // Set up an event listener for the filter input field.
            filterInput.addEventListener('input', function () {
                // Get the value of the filter input field.
                const filterValue = this.value;

                // Filter the table rows based on the filter value.
                const filteredRows = $(`#myTable tbody tr`).filter(function () {
                    // Get the event value of the current row.
                    const eventValue = $(this).find('td:nth-child(6)').text();

                    // Return true if the event value matches the filter value.
                    return eventValue.toLowerCase().includes(filterValue.toLowerCase());
                });

                // Hide all table rows and then show only the filtered rows.
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (res.status == 404) {
                        ...
                        $('#eventName').val(res.data.eventName);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (res.status == 404) {
                        ...
                        $('#view_eventName').text(res.data.eventName);
